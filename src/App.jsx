...
const WeatherDashboard = () => {
  ...
  const [city, setCity] = useState('Jaipur'); // Default city is set to London
  ...
  const fetchAirQualityData = (lat, lon) => {
    const API_KEY = 'ff2cd69635424a50f8ec7407e9fc88ce'; // Replace with your OpenWeatherMap API key
